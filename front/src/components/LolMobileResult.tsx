    ...
    >
      ...
      >
        {lolStore.loading ? (
          ...
          user && (
            <>
              <ProfileCard user={user} width={Math.min(lolStore.windowWidth - 40, 700)} />
              <div
                css={css`
                  margin-top: 10px;
                `}
                ...
                {user.lastGames.map((game, index) => {
                  return (
                    <>
                      ...
                      >
                        <GameCard game={game} width={Math.min(lolStore.windowWidth - 40, 700)} />
                      </div>
                      {index === gameIndex && (
                        <GameDetail
                          width={Math.min(lolStore.windowWidth - 40, 700)}
